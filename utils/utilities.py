...
train_splits_dict = {1: [2, 3, 4], 2: [1, 3, 4],
                     3: [1, 2, 4], 4: [1, 2, 3], -1: [1, 2, 3, 4]}
validation_split_dict = {1: [1], 2: [2], 3: [3], 4: [5], -1: [4]}
test_split_dict = {1: [1], 2: [2], 3: [3], 4: [5], -1: [4]}
...
def logging_and_writer(data_type, metrics, logging, writer=[], batch_idx=0):
    ...
    if data_type == 'train':
        ...
        writer.add_scalar('train/DOA_frame_recall',
                          tr_doa_er_metric[1], batch_idx)
        ...
        writer.add_scalar('valid/DOA_frame_recall',
                          va_doa_er_metric[1], batch_idx)
